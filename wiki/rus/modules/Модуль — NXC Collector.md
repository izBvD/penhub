...
- **CUSTOM** —  отображение учетных записей, добавленных с помощью модуля Toolbox, см. [Модуль — Toolbox](Модуль%20—%20Toolbox.md).
...
> Кнопка **ALL CREDS ↓** переехала отсюда в модуль **[Reports](Модуль%20—%20Reports.md)**. Сама выгрузка не изменилась.
...
Что означает каждая уязвимость и как её устранить — см. **[Справочник по функционалу VULNS](../vulns/Справочник%20по%20функционалу%20VULNS.md)** и **[Описание уязвимостей и их устранение](../vulns/Описание%20уязвимостей%20и%20их%20устранение.md)**.
